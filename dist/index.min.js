...
var request=require("request-promise-native"),JsonRpcRequest=function(a){this.url=a;this.id=1};
JsonRpcRequest.prototype.call=function(a,b){b=void 0===b?[]:b;var d=this,e,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress)return f.setCatchFinallyBlocks(2),f.yield(request({method:"POST",url:d.url,json:!0,body:{jsonrpc:"2.0",id:d.id++,method:a,params:b}}),4);if(2!=f.nextAddress)return e=f.yieldResult,f.return(e.result);c=f.enterCatchBlock();throw Error(c.error.message);})};module.exports=JsonRpcRequest;